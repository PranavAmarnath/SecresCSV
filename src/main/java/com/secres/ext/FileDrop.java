	...
	{   
		...
		{   // Make a drop listener
			...
			if( isDragOk( out, evt ) )
			{
				...
				// BEGIN 2021-03-08 Pranav Amarnath -- Allow only CSV and TXT files.
				java.util.List fileList = null;
				try {
					fileList = (java.util.List) 
				...
				// END 2021-03-08 Pranav Amarnath -- Allow only CSV and TXT files.
			}   // end if: drag ok
			else 
			{   // Reject the drag event
				evt.rejectDrag();
